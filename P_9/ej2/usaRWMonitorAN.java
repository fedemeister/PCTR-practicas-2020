...
/**
 * The type Usa rw monitor an.*
 *
 * @author Federico Carrillo Chaves
 * @version 1.3
 */
public class usaRWMonitorAN {
  /** The constant rwMonitorAN. */
  public static RWMonitorAN rwMonitorAN = new RWMonitorAN();
  ...
  static class Reader extends Thread {
    public void run() {
      rwMonitorAN.StartRead();
      rwMonitorAN.sharedResource++;
      System.out.println("Leyendo Reader.this.getId() = " + this.getId());
      // System.out.println("El Reader " + this.getId() + " esta leyendo");
      rwMonitorAN.EndRead();
    }
  }
  ...
  static class Writer extends Thread {
    public void run() {
      rwMonitorAN.StartWrite();
      rwMonitorAN.sharedResource--;
      System.out.println("Escribiendo.this.getId() = " + this.getId());
      rwMonitorAN.EndWrite();
    }
  }
  ...
  public static void main(String[] args) {
    ...
    System.out.println("RWMonitorAN.sharedResource = " + RWMonitorAN.sharedResource);
  }
}
